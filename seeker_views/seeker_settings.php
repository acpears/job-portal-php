...
$query_getUser = "SELECT * FROM Seeker s JOIN Seeker_Plan sp ON s.plan_name = sp.name WHERE id = '$userId'";
$user = mysqli_fetch_assoc(mysqli_query($db, $query_getUser));
$_SESSION['enabled'] = $user['enabled'];


// Query to load the current payment methods of seeker
$query_paymentMethods = "SELECT pm.id, type, card_number, expiry_date, account_number, ba.owner_name AS ba_owner_name, cc.owner_name AS cc_owner_name FROM Seeker s
...
$query_plans = "SELECT * FROM Seeker_Plan ORDER BY monthly_cost";
        ...
        <div class="container-fluid">
            <div class="row my-3">
                ...
                <div class="col text-right">
                    <form action="./seeker_scripts/settings_scripts.php" method="post">
                                ...
                                <div class="card-body pb-4">
                                        ...
                                        <?php while($row = mysqli_fetch_assoc($result_paymentMethods)){
                                            ...
                                            <div class="list-group-item list-group-item-secondary mb-3 pb-0">
                                                <div class="row">
                                                    ...
                                                    <form action="./seeker_scripts/settings_scripts.php" method="post" class="col">
                                    ...
                                    <div class="container">
                                            ...
                                            <div id="creditCard" style="display: none;" >
                                                <form action="./seeker_scripts/settings_scripts.php" id="payment-form" method="post">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-9">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="form-group form-inline">
                                                            <form action="./seeker_scripts/settings_scripts.php" method="post" class="form-inline">
