...
<html>
    ...
    <?php include_once('./seeker_navbar.php');?>
        <div class="jumbotron">
            <h1 class="display-3 mb-4">Welcome <?= $user['first_name'] ?> <?= $user['last_name'] ?> </h1>
            <!-- <p class="lead">Acount ID: <?= $user['id'] ?></p> -->
            <p class="lead">Email: <?= $user['email']?></p>
            <p class="lead">Acount Type: Job Seeker</p>
            <p class="lead">Acount Plan: <?= ucfirst($user['plan_name']) ?></p>
